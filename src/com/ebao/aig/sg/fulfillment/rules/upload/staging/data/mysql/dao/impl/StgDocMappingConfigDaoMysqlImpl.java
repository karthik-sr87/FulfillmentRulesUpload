...
public class StgDocMappingConfigDaoMysqlImpl implements StgDocMappingConfigDao{
  ...
  public java.lang.Long create(StgDocMappingConfig entity) throws GenericException{
	  System.out.println("Persistence Type : "+Env.getValue("PERSISTENCE_TYPE"));
...
if ( entity.getDocRuleId() == null || entity.getDocRuleId().longValue()<=0 ) {
	...
	try {
	  ...
	  if(rs.next())
		  entity.setDocRuleId(rs.getLong(1));
